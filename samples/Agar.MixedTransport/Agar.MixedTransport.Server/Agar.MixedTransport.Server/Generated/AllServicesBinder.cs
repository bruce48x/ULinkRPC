...
namespace Shared.Interfaces.Server.Generated
{
    public static class AllServicesBinder
    {
        ...
        {
            AuthServiceBinder.BindFactory(registry, CreateServiceFactory<IAuthService>());
            BattleServiceBinder.Bind(registry, CreateCallbackServiceFactory<IBattleService, IBattleCallback>());
        }
